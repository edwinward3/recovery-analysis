"""Focused validity tests for the cross-sectional fallback model design."""
...
class LockedEvaluationTests(TestCase):
    def test_development_and_locked_evaluation_are_separate(self) -> None:
        ...
        with self.assertRaisesRegex(ModelDataError, "implicit test evaluation"):
            fit_evaluate_models(cohort, settings)
